  ...
  return (
    <div className="flex flex-wrap -mx-4 mt-5 ">
      {cardData.map((card: Card, id: number) => (
        <div
          key={id}
          className="h-80 w-full bg-white shadow-lg overflow-hidden m-4 md:w-1/2 lg:w-1/4 mb-4 "
        >
          <img
          ...
          <div className="p-3 flex flex-col">
            ...
            <div className="flex items-start">
              ...
              <FaStar className="w-4 h-4 text-yellow-400" />
              <FaStar className="w-4 h-4 text-yellow-400" />
              <span className="font-Poppins text-xs font-normal text-[#5e6d77] ml-5">{`${card.reviews} Reviews`}</span>
            </div>
