    ...
    <div className="w-full padding pb-10 md:pb-16">
      <section className="flex flex-col md:flex-row gap-3">
        <section className="w-full  md:w-2/3 flex h-fit ">
          <div className="w-1/6 felx-shrink-0  overflow-hidden">
            <IoMdCheckmarkCircle className="max-w-[80px] min-w-[50px] w-full h-full text-green-500" />
          </div>
          <div className="w-5/6 flex flex-col justify-center ">
            <h1 className="text-sm sm:text-base font-medium">
              <span className="font-bold">Anshid</span> your booking was
      ...
      <section className="flex flex-col md:flex-row gap-3 mt-5">
        ...
        <section className="w-full  md:w-1/3  h-fit  bo rder rounded">
          ...
          <div className=' w-full  justify-center mt-5 flex md:hidden'>
                    <button className='bg-blue-500 text-white mx-auto text-sm font-semibold px-4 py-2 rounded'>Booking History</button>
                </div>
        </section>
      </section>
    </div>
